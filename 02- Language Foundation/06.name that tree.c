/*Problem Statement:
As you cross a forest you can't help but 
admire the nature around you including the 
many species of trees. Despite your interest, 
you are a very unskilled botanist and have a 
lot of trouble identifying different trees. 
A friend gives you some guidance and you decide to 
write a program that will give you the name of the 
...
and number of leaflets does not match any of the tree type descriptions, your program should display 
"Uncertain".  
*/
...
int main(void){
    ...
    //input height and number of tree
    scanf("%d%d",&height,&number);
    
    if(height<=5 && number>=8) printf("Tinuviel");
    else if(height>=10 && number>=10) printf("Calaelen");
    else if(height <=8 && number<=5 ) printf("Falarion");
    else if(height >=12 && number<=7 ) printf("Dorthonion");
